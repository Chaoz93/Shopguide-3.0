...
(function(){
  // ----- styles -----
  const CSS = `
  .rs-root{height:100%;display:flex;flex-direction:column;gap:.6rem;--rs-surface-bg:rgba(21,45,76,.82);--rs-surface-text:var(--text-color);--rs-surface-border:rgba(76,114,163,.32);--rs-inline-bg:rgba(21,45,76,.72);--rs-inline-border:var(--module-border-color);--rs-button-bg:var(--module-button-bg, var(--button-bg,#005983));--rs-button-text:var(--module-button-text, var(--button-text,#fff));--rs-button-border:var(--module-button-border, var(--button-border,#0f6ab4));--rs-button-secondary-bg:#6b7280;--rs-button-secondary-text:#fff;--rs-button-shadow:rgba(0,89,131,.28);--rs-button-shadow-strong:rgba(0,89,131,.34)}
  @supports(color-mix(in srgb, #000 0%, transparent)){
    .rs-root{--rs-button-shadow:color-mix(in srgb, var(--rs-button-bg, var(--module-button-bg, var(--button-bg,#005983))) 32%, transparent);--rs-button-shadow-strong:color-mix(in srgb, var(--rs-button-bg, var(--module-button-bg, var(--button-bg,#005983))) 38%, transparent)}
  }
  ...
  .rs-root .rs-input{width:100%;background:var(--rs-button-bg, var(--module-button-bg, var(--button-bg,#005983)));border:1px solid var(--rs-button-border, var(--module-button-border, var(--button-border, var(--rs-button-bg, var(--module-button-bg, var(--button-bg,#005983))))));color:var(--rs-button-text, var(--module-button-text, var(--button-text,#fff)));padding:.45rem .55rem;border-radius:.4rem;cursor:pointer;font-weight:600;box-shadow:0 8px 20px var(--rs-button-shadow, rgba(0,89,131,.28));transition:filter .2s ease,transform .12s ease,box-shadow .2s ease}
  .rs-root .rs-input:hover{filter:brightness(1.05);box-shadow:0 12px 26px var(--rs-button-shadow-strong, rgba(0,89,131,.34))}
