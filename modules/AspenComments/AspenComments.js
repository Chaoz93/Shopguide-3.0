(function(){
  ...
  const CSS=`
    ...
    .dc-status-item{background:linear-gradient(150deg,rgba(15,23,42,.78),rgba(30,64,118,.7));color:var(--module-header-text,#fff);border-radius:1rem;padding:.75rem .9rem;border:1px solid rgba(148,163,184,.28);box-shadow:0 18px 36px rgba(15,23,42,.45);display:flex;flex-direction:column;gap:.5rem;min-height:104px;}
    .dc-status-header{display:flex;align-items:center;gap:.5rem;font-size:.78rem;font-weight:700;text-transform:uppercase;letter-spacing:.05em;color:rgba(226,232,240,.85);}
    ...
    .dc-value-pill{display:inline-flex;align-items:center;gap:.45rem;max-width:100%;padding:.38rem .7rem;border-radius:.7rem;background:rgba(148,163,184,.22);color:var(--module-header-text,#fff);font-weight:600;font-size:.9rem;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;}
    .dc-value-pill.is-empty{background:rgba(15,23,42,.45);color:rgba(226,232,240,.8);}
    .dc-unit{display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:.6rem;}
    .dc-field{background:linear-gradient(150deg,rgba(15,23,42,.78),rgba(30,64,118,.7));color:var(--module-header-text,#fff);border-radius:.85rem;padding:.6rem .85rem;box-shadow:0 12px 26px rgba(15,23,42,.4);border:1px solid rgba(148,163,184,.28);}
    ...
    .dc-note{min-height:1.2rem;font-size:.8rem;color:rgba(226,232,240,.78);}
