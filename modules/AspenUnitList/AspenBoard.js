...
(function(){
  ...
  const CSS = `
    ...
    .db-card.active{box-shadow:0 0 0 2px var(--dl-active,var(--ab-accent,#2f7edb)) inset,0 14px 32px rgba(12,24,41,.45);transform:translateY(-1px);color:#fff;}
    .db-ghost{opacity:.4;}
    ...
    .aspenboard{
      ...
      --dl-active:var(--ab-accent,#2f7edb);
    }
    .aspenboard .db-modal{
