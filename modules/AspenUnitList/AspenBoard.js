...
(function(){
  ...
  const CSS = `
    ...
    .db-extra-name-header{display:flex;align-items:center;justify-content:flex-start;gap:.65rem;flex-wrap:wrap;}
    ...
    .db-extra-uc-switch{position:relative;display:inline-flex;align-items:center;gap:.4rem;padding:.2rem .55rem .2rem .25rem;border-radius:999px;font-size:.75rem;font-weight:600;color:var(--dl-sub,#4b5563);cursor:pointer;user-select:none;transition:color .2s ease,opacity .2s ease;}
