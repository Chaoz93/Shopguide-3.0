...
(function(){
  ...
  const CSS = `
    ...
    .db-toggle-btn.is-active{background:var(--tab-inactive-bg,#e5e7eb);color:var(--tab-inactive-text,#1f2937);border:2px solid var(--tab-inactive-bg,#e5e7eb);box-shadow:none;}
    ...
    .db-config-tab.is-active{background:var(--tab-inactive-bg,#e5e7eb);color:var(--tab-inactive-text,#1f2937);border:2px solid var(--tab-inactive-bg,#e5e7eb);box-shadow:none;}
