...
(function(){
  ...
  const CSS = `
    ...
    .db-extra-uc-switch{position:relative;display:inline-flex;align-items:center;gap:.35rem;padding:.2rem .25rem .2rem 0;border-radius:999px;font-size:.75rem;font-weight:600;color:var(--dl-sub,#4b5563);cursor:pointer;user-select:none;transition:color .2s ease,opacity .2s ease;}
