(function(){
  ...
  function startAssignMode(moduleName, groups){
    ...
    const existingBackdrop = document.getElementById('assign-ui-backdrop');
    if(existingBackdrop){
    ...
    blurLayer.id = 'assign-ui-backdrop';
  ...
  function ensureStyles(){
    ...
    .flv-test-ui{padding:1rem;border-radius:.9rem;border:1px solid var(--module-preview-border,rgba(255,255,255,.1));background:color-mix(in srgb,var(--module-preview-bg,rgba(15,23,42,.45)) 86%, #0f172a 14%);box-shadow:0 10px 24px rgba(15,23,42,.32);display:flex;flex-direction:column;gap:.75rem;min-height:0;color:var(--module-preview-text,#e2e8f0);transition:transform .25s ease;will-change:transform;}
    ...
    .flv-main-preview{margin-bottom:1.5rem;padding:1.25rem;border-radius:1.1rem;border:1px solid var(--module-preview-border,rgba(255,255,255,.08));background:var(--module-preview-bg,rgba(15,23,42,.5));box-shadow:0 14px 30px rgba(15,23,42,.35);display:flex;flex-direction:column;gap:1rem;color:var(--module-preview-text,#f8fafc);transition:transform .25s ease;will-change:transform;}
    ...
    #assign-ui-overlay{position:fixed;inset:0;display:flex;align-items:center;justify-content:flex-end;z-index:9998;background:linear-gradient(135deg,rgba(15,23,42,.12),rgba(14,116,144,.06));color:#0f172a;pointer-events:none;transition:background .25s ease,opacity .25s ease;}
    ...
    .assign-sidebar{width:260px;background:rgba(15,23,42,.94);padding:1.1rem 1rem;border:1px solid rgba(148,163,184,.35);display:flex;flex-direction:column;gap:.6rem;pointer-events:auto;color:#e2e8f0;box-shadow:0 20px 48px rgba(15,23,42,.5);transform:translateX(0);transition:transform .3s ease,opacity .3s ease,box-shadow .3s ease;position:relative;z-index:1;border-radius:1rem;backdrop-filter:blur(4px);-webkit-backdrop-filter:blur(4px);}
    ...
    @media (max-width:1024px){body.flv-assign-mode-active .flv-main-preview{max-width:min(88vw,760px);width:min(88vw,760px);}body.flv-assign-mode-active .assign-sidebar{right:clamp(.75rem,3vw,2rem);}}
    @media (max-width:860px){body.flv-assign-mode-active .assign-sidebar{top:auto;bottom:1.5rem;left:50%;right:auto;transform:translate(-50%,0);width:min(90vw,360px);max-height:calc(55vh);box-shadow:0 18px 42px rgba(15,23,42,.48);}body.flv-assign-mode-active .flv-main-preview{top:45%;max-height:calc(100vh - 10rem);width:min(92vw,640px);max-width:min(92vw,640px);}}
