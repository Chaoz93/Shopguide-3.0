(function(){
  ...
  function ensureStyles(){
    ...
    @media (max-width:1280px){body.flv-assign-mode-active .flv-main-preview{max-width:min(92vw,1080px);width:min(92vw,1080px);}}
